...
const GLOBAL_DURATION = Number(process.env.RATE_LIMIT_GLOBAL_DURATION ?? 600);
const HEAVY_POINTS    = Number(process.env.RATE_LIMIT_HEAVY_POINTS    ?? 600);   // writes/heavy
const HEAVY_DURATION  = Number(process.env.RATE_LIMIT_HEAVY_DURATION  ?? 600);
const BOT_POINTS      = Number(process.env.RATE_LIMIT_BOT_POINTS      ?? 1800); // internal bot
const BOT_DURATION    = Number(process.env.RATE_LIMIT_BOT_DURATION    ?? 600);
