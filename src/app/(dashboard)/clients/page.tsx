...
export default function ClientForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      toast({
        ...
        description: error.message || "There was a problem creating the client. Please try again.",
        variant: "destructive",
      })
    } finally {
  ...
  return (
    <div className="w-full mx-auto p-6 border border-border rounded-lg bg-background">
      <div className="mb-6">
        <h2 className="text-2xl font-bold tracking-tight">Create New Client</h2>
        <p className="text-muted-foreground mt-1">
          Add a new client. All fields marked with * are required.
        </p>
      </div>
